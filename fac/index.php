...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b ng-bind="config.title"></b> <span ng-bind="config.iniciales"></span></span>
    </a>
...
-->
  ...
  <footer class="main-footer">
    <!-- To the right -->
    <div class="pull-right hidden-xs" ng-bind="config.version">

    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <span ng-bind="config.anio"></span> <a href="{{config.web }}" target="blank"><span ng-bind="config.empresa"></span></a>.</strong> All rights reserved.
  </footer>
